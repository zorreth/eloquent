...
Every Minecraft mob gets a unique AI identity, memory, and voice.
...
1. Run `/eloquent setkey <key>` to set the OpenAI secret key. Do the same with `setbaseurl` and `setmodel` if needed.
2. Chat with AI using `/eloquent chat <message>` (or `/e <message>` as a shortcut). If you happen to be near any mobs, they will respond to you!
